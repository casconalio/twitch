...
defined('AWS_API_KEY') or define('AWS_API_KEY', 'AKIAJU3VVP2BZIY3Q7PQ');
defined('AWS_API_SECRET_KEY') or define('AWS_API_SECRET_KEY', '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');
defined('AWS_ASSOCIATE_TAG') or define('AWS_ASSOCIATE_TAG', 't0f44b-20');
defined('AWS_ANOTHER_ASSOCIATE_TAG') or define('AWS_ANOTHER_ASSOCIATE_TAG', 't0f44b-20');
