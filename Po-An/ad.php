...
<div class="ad-container">
    <div class="popularity">
        ...
        $pop_num = 0;
        foreach($pop as $row){ $pop_num =  $row[0]; }
        $dark_pos = 20 - $pop_num;
        for ($i=1; $i<=20; $i++){
            if ($i <= $dark_pos){
    ...
    <a href="ad.post.php?search=<?php echo $search ?>&url=<?php echo $response['Items']['Item'][0]['DetailPageURL'] ?>">
    <div class="ad">
        <div class="pic">
            <?php
        ...
        <div class="text">
            <div class="title"><?php echo '' . $response['Items']['Item'][0]['ItemAttributes']['Title'] . ''; ?></div>
            <div class="price">
                <?php
